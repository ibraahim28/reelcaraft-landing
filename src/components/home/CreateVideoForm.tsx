...
const CreateVideoForm: React.FC = () => {
  ...
  return (
    <div className="relative bg-gradient-to-br from-primary-600 to-primary-900 rounded-2xl overflow-hidden">
      ...
      <div className="relative p-8 md:p-12">
        <div className="text-center mb-8">
          ...
          <p className="text-primary-100 max-w-xl mx-auto">
            Start with your topic and let our AI do the rest. We'll generate a
            script, voiceover, and visuals for you.
          </p>
        </div>

        <form
          onSubmit={handleSubmit}
          className="max-w-xl mx-auto glass p-6 rounded-xl"
        >
          <div className="mb-6">
            <Input
          ...
          <Button
            ...
            isLoading={isLoading}
            rightIcon={
              isLoading ? undefined : <ArrowRight className="w-5 h-5" />
            }
            className="mt-2"
          >
